...
with open(readme_admin, "w", encoding="utf-8") as f:
    f.write(
        ...
        "ถ้าขึ้นว่า 'Smart App Control blocked an app' (Windows 11 เครื่องใหม่):\n"
        "  โปรแกรมนี้ยังไม่ได้ซื้อใบรับรองผู้พัฒนาของ Windows เลยถูกบล็อกไว้ก่อน\n"
        "  วิธีเปิดใช้งาน:\n"
        "    1. กดปุ่ม Start พิมพ์ 'Windows Security' แล้วเปิดขึ้นมา\n"
        "    2. เลือก 'App & browser control'\n"
        "    3. หัวข้อ 'Smart App Control' กด 'Smart App Control settings'\n"
        "    4. เลือก 'Off' แล้วยืนยัน\n"
        "    5. เปิดโปรแกรมนี้ใหม่อีกครั้ง\n"
        "  (ปิดแล้วเปิดกลับไม่ได้ ต้องลง Windows ใหม่ — แต่ Defender ยังทำงานปกติ)\n\n"
